...
import avatar6 from '../../imgs/avatar6.png'
import avatar7 from '../../imgs/avatar7.png'
import avatar8 from '../../imgs/avatar8.png'
import avatar9 from '../../imgs/avatar9.png'

const Home = () => (

    <div>
      <section class="fdb-block fp-active jumbotron jumbotron-fluid text-light"  data-block-type="contents" data-id="2" draggable="true">
        <div class="container">
...
<section class="fdb-block pb-0 fundolegal01"  data-block-type="contents" data-id="9" draggable="true">
  <div class="container">
  ...
  <div class="container">
    <div class="row mt-5">
      ...
      <div class="col-12 col-md-6 ml-auto pt-5 pt-md-0">
        <form method="post" name="think" netlify>
          <div class="row">
            <div class="col">
...
<section class="fdb-block team-5" data-block-type="teams" data-id="11" draggable="true">
  <div class="container">
    ...
    <div class="row text-center justify-content-center avatares">
      <div class="col-sm-2 m-sm-auto">        <img alt="image" class="img-fluid" src={avatar1}/>
      ...
      <div class="col-sm-2 m-sm-auto">
        <img alt="image" class="img-fluid" src={avatar2}/>
      ...
      <div class="col-sm-2 m-sm-auto">
        <img alt="image" class="img-fluid" src={avatar3}/>
      ...
      <div class="col-sm-2 m-sm-auto">
        <img alt="image" class="img-fluid" src={avatar4}/>
    ...
    <div class="row justify-content-center text-center avatares">
      <div class="col-sm-2  m-sm-auto">
        <img alt="image" class="img-fluid" src={avatar5}/>
      ...
      <div class="col-sm-2 m-sm-auto">
        <img alt="image" class="img-fluid" src={avatar6}/>
      ...
      <div class="col-sm-2 m-sm-auto">
        <img alt="image" class="img-fluid" src={avatar7}/>
      ...
      <div class="col-sm-2 m-sm-auto">
        <img alt="image" class="img-fluid" src={avatar8}/>
